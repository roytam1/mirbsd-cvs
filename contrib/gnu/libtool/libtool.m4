...
dnl This is originally from Autoconf 2.59
dnl but modified to find our cpp as well
dnl
# AC_PROG_CXXCPP
# --------------
...
AC_CACHE_VAL([lt_cv_sys_max_cmd_len], [dnl
  ...
  darwin* | dragonfly* | freebsd* | midnightbsd* | mirbsd* | netbsd* | openbsd*)
...
case $host_os in
  ...
  freebsd-elf*)
    _LT_AC_TAGVAR(archive_cmds_need_lc, $1)=no
    ;;
  freebsd* | kfreebsd*-gnu | dragonfly* | midnightbsd*)
...
lt_cv_path_SED=${lt_cv_path_SED-$SED}
SED=$lt_cv_path_SED
AC_SUBST([SED])
AC_MSG_RESULT([$SED])
])
