/* $MirOS: contrib/code/libhaible/towlower.c,v 1.8 2006/05/30 10:45:38 tg Exp $ */
...
__RCSID("$MirOS: contrib/code/libhaible/towlower.c,v 1.8 2006/05/30 10:45:38 tg Exp $");
