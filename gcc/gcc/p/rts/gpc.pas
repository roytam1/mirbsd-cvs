...
function  StrEqualCase    (const s1, s2: String): Boolean;                        attribute (name = '_p_StrEqualCase'); external;

function  Pos             (const SubString, s: String): Integer;                  attribute (name = '_p_Pos'); external;
function  PosChar         (const ch: Char; const s: String): Integer;             attribute (name = '_p_PosChar'); external;
function  LastPos         (const SubString, s: String): Integer;                  attribute (name = '_p_LastPos'); external;
function  PosCase         (const SubString, s: String): Integer;                  attribute (name = '_p_PosCase'); external;
function  LastPosCase     (const SubString, s: String): Integer;                  attribute (name = '_p_LastPosCase'); external;
...
function  PosFrom         (const SubString, s: String; From: Integer): Integer;            attribute (name = '_p_PosFrom'); external;
function  LastPosTill     (const SubString, s: String; Till: Integer): Integer;            attribute (name = '_p_LastPosTill'); external;
function  PosFromCase     (const SubString, s: String; From: Integer): Integer;            attribute (name = '_p_PosFromCase'); external;
function  LastPosTillCase (const SubString, s: String; Till: Integer): Integer;            attribute (name = '_p_LastPosTillCase'); external;
...
function  IsPrefix        (const Prefix, s: String): Boolean;                    attribute (name = '_p_IsPrefix'); external;
function  IsSuffix        (const Suffix, s: String): Boolean;                    attribute (name = '_p_IsSuffix'); external;
function  IsPrefixCase    (const Prefix, s: String): Boolean;                    attribute (name = '_p_IsPrefixCase'); external;
function  IsSuffixCase    (const Suffix, s: String): Boolean;                    attribute (name = '_p_IsSuffixCase'); external;
...
procedure SetEnv (const VarName, Value: String);                          attribute (name = '_p_SetEnv'); external;
...
function  FSearch (const aFileName, DirList: String): TString;           attribute (name = '_p_FSearch'); external;
...
function  FSearchExecutable (const aFileName, DirList: String) = Result: TString; attribute (name = '_p_FSearchExecutable'); external;
...
procedure FSplit (const Path: String; var Dir, BaseName, Ext: String);   attribute (name = '_p_FSplit'); external;
...
function  FindNonQuotedStr (const SubString, s: String; From: Integer): Integer; attribute (name = '_p_FindNonQuotedStr'); external;
...
function  FileNameMatch (const Pattern, FileName: String): Boolean;      attribute (name = '_p_FileNameMatch'); external;

{ FileNameMatch with BraceExpand }
function  MultiFileNameMatch (const Pattern, FileName: String): Boolean; attribute (name = '_p_MultiFileNameMatch'); external;
...
{ Returns a file name suitable for a global (system-wide) or local
  ...
  executables. }
function  ConfigFileName (const Prefix, BaseName: String; Global: Boolean): TString; attribute (name = '_p_ConfigFileName'); external;
...
function  DataDirectoryName (const Prefix, BaseName: String): TString; attribute (name = '_p_DataDirectoryName'); external;
