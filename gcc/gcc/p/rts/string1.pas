...
function  StrEqualCase    (const s1, s2: String): Boolean;                        attribute (name = '_p_StrEqualCase');

function  Pos             (const SubString, s: String): Integer;                  attribute (name = '_p_Pos');
function  PosChar         (const ch: Char; const s: String): Integer;             attribute (name = '_p_PosChar');
function  LastPos         (const SubString, s: String): Integer;                  attribute (name = '_p_LastPos');
function  PosCase         (const SubString, s: String): Integer;                  attribute (name = '_p_PosCase');
function  LastPosCase     (const SubString, s: String): Integer;                  attribute (name = '_p_LastPosCase');
...
function  PosFrom         (const SubString, s: String; From: Integer): Integer;            attribute (name = '_p_PosFrom');
function  LastPosTill     (const SubString, s: String; Till: Integer): Integer;            attribute (name = '_p_LastPosTill');
function  PosFromCase     (const SubString, s: String; From: Integer): Integer;            attribute (name = '_p_PosFromCase');
function  LastPosTillCase (const SubString, s: String; Till: Integer): Integer;            attribute (name = '_p_LastPosTillCase');
...
function  IsPrefix        (const Prefix, s: String): Boolean;                    attribute (name = '_p_IsPrefix');
function  IsSuffix        (const Suffix, s: String): Boolean;                    attribute (name = '_p_IsSuffix');
function  IsPrefixCase    (const Prefix, s: String): Boolean;                    attribute (name = '_p_IsPrefixCase');
function  IsSuffixCase    (const Suffix, s: String): Boolean;                    attribute (name = '_p_IsSuffixCase');
