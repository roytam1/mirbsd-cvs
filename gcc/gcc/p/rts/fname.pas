...
function  FSearch (const aFileName, DirList: String): TString;           attribute (name = '_p_FSearch');
...
function  FSearchExecutable (const aFileName, DirList: String) = Result: TString; attribute (name = '_p_FSearchExecutable');
...
procedure FSplit (const Path: String; var Dir, BaseName, Ext: String);   attribute (name = '_p_FSplit');
...
function  FindNonQuotedStr (const SubString, s: String; From: Integer): Integer; attribute (name = '_p_FindNonQuotedStr');
...
function  FileNameMatch (const Pattern, FileName: String): Boolean;      attribute (name = '_p_FileNameMatch');

{ FileNameMatch with BraceExpand }
function  MultiFileNameMatch (const Pattern, FileName: String): Boolean; attribute (name = '_p_MultiFileNameMatch');
...
{ Returns a file name suitable for a global (system-wide) or local
  ...
  executables. }
function  ConfigFileName (const Prefix, BaseName: String; Global: Boolean): TString; attribute (name = '_p_ConfigFileName');
...
function  DataDirectoryName (const Prefix, BaseName: String): TString; attribute (name = '_p_DataDirectoryName');
...
procedure FSplit (const Path: String; var Dir, BaseName, Ext: String);
var
  d, e: Integer;
  p, t: TString;
begin
...
function MultiFileNameMatch (const Pattern, FileName: String): Boolean;
var
  s: PPStrings;
  i: Integer;
begin
...
function ConfigFileName (const Prefix, BaseName: String; Global: Boolean): TString;
var PName: TString;
begin
  {$ifdef __OS_DOS__}
  var Dir: TString;
...
function DataDirectoryName (const Prefix, BaseName: String): TString;
