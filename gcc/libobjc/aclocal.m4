dnl aclocal.m4 generated automatically by aclocal 1.4p6-MirPorts-5
...
# $MirOS: src/gnu/share/libtool.m4,v 1.12 2006/03/27 21:07:05 tg Exp $
# _MirOS: contrib/gnu/libtool/libtool.m4,v 1.49 2006/03/27 19:57:44 tg Exp $
...
# This diff chunk is needed for autoconf 2.13 compatibility, too.
...
# _LT_AC_LANG_CXX
# ---------------
# with a little hack for autoconf 2.13 in case g++ is not installed
...
# _LT_AC_LANG_F77
# ---------------
# with a little hack for autoconf 2.13 in case g77 is not installed
...
# It is derived from GNU Libtool:
