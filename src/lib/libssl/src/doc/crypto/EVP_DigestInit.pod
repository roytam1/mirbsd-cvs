...
EVP_md2(), EVP_md5(), EVP_sha(), EVP_sha1() and EVP_ripemd160()
return B<EVP_MD> structures for the MD2, MD5, SHA, SHA1 and RIPEMD160 digest
...
L<MD5(3)|MD5(3)>, L<RIPEMD160(3)|RIPEMD160(3)>,
L<SHA1(3)|SHA1(3)>
