...
To use the B<idea> algorithm, you need to obtain a patent licence,
cf. e.g. B<http://www.mediacrypt.com/_contents/10_idea/102040_li_nc.asp>
or the site map, but it might not always be disabled by default.
