...
#else
#endif
int	compat_78_sys_stat(struct proc *, void *, register_t *);
int	compat_78_sys_fstat(struct proc *, void *, register_t *);
int	compat_78_sys_lstat(struct proc *, void *, register_t *);
...
int	compat_78_sys_fhstat(struct proc *, void *, register_t *);
