...
struct sysent openbsd_sysent[] = {
	...
	{ 3, s(struct compat_25_sys_getfsstat_args),
	    compat_25_sys_getfsstat },		/* 18 = ogetfsstat */
	...
	{ 2, s(struct compat_25_openbsd_sys_statfs_args),
	    compat_25_openbsd_sys_statfs },	/* 157 = statfs25 */
	{ 2, s(struct compat_25_sys_fstatfs_args),
	    compat_25_sys_fstatfs },		/* 158 = fstatfs25 */
	{ 0, 0,
