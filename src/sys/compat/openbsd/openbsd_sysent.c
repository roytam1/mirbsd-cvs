...
struct sysent openbsd_sysent[] = {
	...
	{ 3, s(struct sys_write_args),
	    sys_write },			/* 4 = write */
	{ 3, s(struct openbsd_sys_open_args),
	    openbsd_sys_open },			/* 5 = open */
	{ 1, s(struct sys_close_args),
	    sys_close },			/* 6 = close */
	{ 4, s(struct compat_time_sys_wait4_args),
	    compat_time_sys_wait4 },		/* 7 = wait4 */
	{ 2, s(struct compat_43_openbsd_sys_creat_args),
	    compat_43_openbsd_sys_creat },	/* 8 = ocreat */
	{ 2, s(struct openbsd_sys_link_args),
	    openbsd_sys_link },			/* 9 = link */
	{ 1, s(struct openbsd_sys_unlink_args),
	    openbsd_sys_unlink },		/* 10 = unlink */
	{ 0, 0,
	    sys_nosys },			/* 11 = obsolete execv */
	{ 1, s(struct openbsd_sys_chdir_args),
	    openbsd_sys_chdir },		/* 12 = chdir */
	{ 1, s(struct sys_fchdir_args),
	    sys_fchdir },			/* 13 = fchdir */
	{ 3, s(struct openbsd_sys_mknod_args),
	    openbsd_sys_mknod },		/* 14 = mknod */
	{ 2, s(struct openbsd_sys_chmod_args),
	    openbsd_sys_chmod },		/* 15 = chmod */
	{ 3, s(struct openbsd_sys_chown_args),
	    openbsd_sys_chown },		/* 16 = chown */
	...
	{ 4, s(struct openbsd_sys_mount_args),
	    openbsd_sys_mount },		/* 21 = mount */
	{ 2, s(struct openbsd_sys_unmount_args),
	    openbsd_sys_unmount },		/* 22 = unmount */
	...
	{ 2, s(struct openbsd_sys_access_args),
	    openbsd_sys_access },		/* 33 = access */
	{ 2, s(struct openbsd_sys_chflags_args),
	    openbsd_sys_chflags },		/* 34 = chflags */
	...
	{ 2, s(struct sys_kill_args),
	    sys_kill },				/* 37 = kill */
	{ 2, s(struct compat_43_openbsd_sys_stat_args),
	    compat_43_openbsd_sys_stat },	/* 38 = ostat */
	{ 0, 0,
	    sys_getppid },			/* 39 = getppid */
	{ 2, s(struct compat_43_openbsd_sys_lstat_args),
	    compat_43_openbsd_sys_lstat },	/* 40 = olstat */
...
#ifdef KTRACE
	{ 4, s(struct openbsd_sys_ktrace_args),
	    openbsd_sys_ktrace },		/* 45 = ktrace */
#else
	{ 0, 0,
	...
	{ 2, s(struct compat_35_sys_osigaltstack_args),
	    compat_35_sys_osigaltstack },	/* 53 = osigaltstack */
	{ 3, s(struct sys_ioctl_args),
	    sys_ioctl },			/* 54 = ioctl */
	{ 1, s(struct sys_reboot_args),
	    sys_reboot },			/* 55 = reboot */
	{ 1, s(struct openbsd_sys_revoke_args),
	    openbsd_sys_revoke },		/* 56 = revoke */
	{ 2, s(struct openbsd_sys_symlink_args),
	    openbsd_sys_symlink },		/* 57 = symlink */
	{ 3, s(struct openbsd_sys_readlink_args),
	    openbsd_sys_readlink },		/* 58 = readlink */
	{ 3, s(struct openbsd_sys_execve_args),
	    openbsd_sys_execve },		/* 59 = execve */
	{ 1, s(struct sys_umask_args),
	    sys_umask },			/* 60 = umask */
	{ 1, s(struct openbsd_sys_chroot_args),
	    openbsd_sys_chroot },		/* 61 = chroot */
	...
	{ 3, s(struct compat_time_sys_setitimer_args),
	    compat_time_sys_setitimer },	/* 83 = setitimer */
	{ 0, 0,
	    compat_43_sys_wait },		/* 84 = owait */
	{ 0, 0,
	    sys_nosys },			/* 85 = unimplemented swapon25 */
	{ 2, s(struct compat_time_sys_getitimer_args),
	    compat_time_sys_getitimer },	/* 86 = getitimer */
	...
	{ 3, s(struct sys_fcntl_args),
	    sys_fcntl },			/* 92 = fcntl */
	{ 5, s(struct compat_35_sys_select_args),
	    compat_35_sys_select },		/* 93 = select */
	{ 0, 0,
	...
	{ 2, s(struct compat_time_sys_gettimeofday_args),
	    compat_time_sys_gettimeofday },	/* 116 = gettimeofday */
	{ 2, s(struct compat_time_sys_getrusage_args),
	    compat_time_sys_getrusage },	/* 117 = getrusage */
	...
	{ 2, s(struct compat_time_sys_settimeofday_args),
	    compat_time_sys_settimeofday },	/* 122 = settimeofday */
	...
	{ 2, s(struct openbsd_sys_rename_args),
	    openbsd_sys_rename },		/* 128 = rename */
	{ 2, s(struct compat_43_openbsd_sys_truncate_args),
	    compat_43_openbsd_sys_truncate },	/* 129 = otruncate */
	{ 2, s(struct compat_43_sys_ftruncate_args),
	    compat_43_sys_ftruncate },		/* 130 = oftruncate */
	{ 2, s(struct sys_flock_args),
	    sys_flock },			/* 131 = flock */
	{ 2, s(struct openbsd_sys_mkfifo_args),
	    openbsd_sys_mkfifo },		/* 132 = mkfifo */
	...
	{ 2, s(struct openbsd_sys_mkdir_args),
	    openbsd_sys_mkdir },		/* 136 = mkdir */
	{ 1, s(struct openbsd_sys_rmdir_args),
	    openbsd_sys_rmdir },		/* 137 = rmdir */
	{ 2, s(struct compat_35_openbsd_sys_utimes_args),
	    compat_35_openbsd_sys_utimes },	/* 138 = utimes */
	{ 0, 0,
	    sys_nosys },			/* 139 = obsolete 4.2 sigreturn */
	{ 2, s(struct compat_35_sys_adjtime_args),
	    compat_35_sys_adjtime },		/* 140 = adjtime */
	...
	{ 4, s(struct openbsd_sys_quotactl_args),
	    openbsd_sys_quotactl },		/* 148 = quotactl */
	{ 0, 0,
	...
	{ 0, 0,
	    sys_nosys },			/* 157 = unimplemented statfs25 */
	{ 0, 0,
	    sys_nosys },			/* 158 = unimplemented fstatfs25 */
	{ 0, 0,
	    sys_nosys },			/* 159 = unimplemented */
	{ 0, 0,
	    sys_nosys },			/* 160 = unimplemented */
	{ 2, s(struct openbsd_sys_getfh_args),
	    openbsd_sys_getfh },		/* 161 = getfh */
	...
	{ 2, s(struct openbsd_sys_pathconf_args),
	    openbsd_sys_pathconf },		/* 191 = pathconf */
	...
	{ 4, s(struct sys_lseek_args),
	    sys_lseek },			/* 199 = lseek */
	{ 3, s(struct openbsd_sys_truncate_args),
	    openbsd_sys_truncate },		/* 200 = truncate */
	{ 3, s(struct sys_ftruncate_args),
	    sys_ftruncate },			/* 201 = ftruncate */
	{ 6, s(struct openbsd_sys___sysctl_args),
	    openbsd_sys___sysctl },		/* 202 = __sysctl */
	...
	{ 2, s(struct compat_35_sys_futimes_args),
	    compat_35_sys_futimes },		/* 206 = futimes */
	...
	{ 3, s(struct compat_23_sys_msgctl_args),
	    compat_23_sys_msgctl },		/* 224 = msgctl23 */
	...
	{ 3, s(struct compat_23_sys_shmctl_args),
	    compat_23_sys_shmctl },		/* 229 = shmctl23 */
	{ 1, s(struct sys_shmdt_args),
	    sys_shmdt },			/* 230 = shmdt */
	{ 3, s(struct compat_35_sys_shmget_args),
	    compat_35_sys_shmget },		/* 231 = shmget35 */
#else
	{ 0, 0,
...
#endif
	{ 2, s(struct compat_time_sys_clock_gettime_args),
	    compat_time_sys_clock_gettime },	/* 232 = clock_gettime */
	{ 2, s(struct compat_time_sys_clock_settime_args),
	    compat_time_sys_clock_settime },	/* 233 = clock_settime */
	{ 2, s(struct compat_time_sys_clock_getres_args),
	    compat_time_sys_clock_getres },	/* 234 = clock_getres */
	{ 0, 0,
	...
	{ 2, s(struct compat_time_sys_nanosleep_args),
	    compat_time_sys_nanosleep },	/* 240 = nanosleep */
	{ 0, 0,
	...
	{ 3, s(struct openbsd_sys_lchown_args),
	    openbsd_sys_lchown },		/* 254 = lchown */
	...
	{ 2, s(struct openbsd_sys_statfs_args),
	    openbsd_sys_statfs },		/* 261 = statfs */
	...
	{ 2, s(struct compat_35_sys_fhstat_args),
	    compat_35_sys_fhstat },		/* 265 = fhstat35 */
	...
	{ 6, s(struct compat_time_sys_kevent_args),
	    compat_time_sys_kevent },		/* 270 = kevent */
...
#endif
	{ 2, s(struct compat_36_sys_stat_args),
	    compat_36_sys_stat },		/* 291 = stat */
	{ 2, s(struct compat_36_sys_fstat_args),
	    compat_36_sys_fstat },		/* 292 = fstat */
	{ 2, s(struct compat_36_sys_lstat_args),
	    compat_36_sys_lstat },		/* 293 = lstat */
	{ 2, s(struct compat_36_sys_fhstat_args),
	    compat_36_sys_fhstat },		/* 294 = fhstat */
#ifdef SYSVSEM
	{ 4, s(struct sys___semctl_args),
	    sys___semctl },			/* 295 = __semctl */
#else
	{ 0, 0,
	    sys_nosys },			/* 295 = unimplemented semctl */
#endif
#ifdef SYSVSHM
...
#else
	{ 0, 0,
	    sys_nosys },			/* 296 = unimplemented shmctl */
#endif
#ifdef SYSVMSG
...
#else
	{ 0, 0,
	    sys_nosys },			/* 297 = unimplemented msgctl */
#endif
};
