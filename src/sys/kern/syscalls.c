...
char *syscallnames[] = {
	...
	"chown",			/* 16 = chown */
	"break",			/* 17 = break */
	"#18 (unimplemented ogetfsstat)",		/* 18 = unimplemented ogetfsstat */
	"olseek",			/* 19 = olseek */
	"getpid",			/* 20 = getpid */
	"mount",			/* 21 = mount */
	"unmount",			/* 22 = unmount */
	...
	"#65 (unimplemented omsync)",		/* 65 = unimplemented omsync */
	"vfork",			/* 66 = vfork */
	...
	"owait",			/* 84 = owait */
	"#85 (unimplemented swapon25)",		/* 85 = unimplemented swapon25 */
	...
	"#157 (unimplemented ostatfs)",		/* 157 = unimplemented ostatfs */
	"#158 (unimplemented ofstatfs)",		/* 158 = unimplemented ofstatfs */
...
#endif
	"#188 (unimplemented stat78)",		/* 188 = unimplemented stat78 */
	"#189 (unimplemented fstat78)",		/* 189 = unimplemented fstat78 */
	"#190 (unimplemented lstat78)",		/* 190 = unimplemented lstat78 */
	...
	"pipe",			/* 263 = pipe */
	"fhopen",			/* 264 = fhopen */
	"#265 (unimplemented fhstat78)",		/* 265 = unimplemented fhstat78 */
	...
	"shmget",			/* 290 = shmget */
#else
	"#290 (unimplemented shmget)",		/* 290 = unimplemented shmget */
#endif
#ifdef SYSVSEM
	"semop",			/* 291 = semop */
#else
	"#291 (unimplemented semop)",		/* 291 = unimplemented semop */
#endif
	"stat",			/* 292 = stat */
	"fstat",			/* 293 = fstat */
	"lstat",			/* 294 = lstat */
	"fhstat",			/* 295 = fhstat */
#ifdef SYSVSEM
	"__semctl",			/* 296 = __semctl */
#else
	"#296 (unimplemented semctl)",		/* 296 = unimplemented semctl */
#endif
#ifdef SYSVSHM
	"shmctl",			/* 297 = shmctl */
#else
	"#297 (unimplemented shmctl)",		/* 297 = unimplemented shmctl */
#endif
#ifdef SYSVMSG
	"msgctl",			/* 298 = msgctl */
#else
	"#298 (unimplemented msgctl)",		/* 298 = unimplemented msgctl */
#endif
	"lchmod",			/* 299 = lchmod */
	"lchflags",			/* 300 = lchflags */
	"lutimes",			/* 301 = lutimes */
};
