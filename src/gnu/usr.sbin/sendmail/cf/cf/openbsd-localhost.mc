divert(-1)dnl
#
# $MirOS: src/gnu/usr.sbin/sendmail/cf/cf/openbsd-localhost.mc,v 1.15 2015/06/03 14:40:13 tg Exp $
...
divert(0)dnl
VERSIONID(`$MirOS: src/gnu/usr.sbin/sendmail/cf/cf/openbsd-localhost.mc,v 1.15 2015/06/03 14:40:13 tg Exp $')dnl
OSTYPE(openbsd)dnl
dnl
dnl
