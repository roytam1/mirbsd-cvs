divert(-1)dnl
#
# $MirOS: src/gnu/usr.sbin/sendmail/cf/cf/openbsd-localhost.mc,v 1.14 2015/05/25 15:06:41 tg Exp $
...
divert(0)dnl
VERSIONID(`$MirOS: src/gnu/usr.sbin/sendmail/cf/cf/openbsd-localhost.mc,v 1.14 2015/05/25 15:06:41 tg Exp $')dnl
OSTYPE(openbsd)dnl
dnl
dnl
