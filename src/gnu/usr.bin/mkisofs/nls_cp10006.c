/* @(#)nls_cp10006.c	1.2 01/01/20 2000 J. Schilling */
#include <sys/cdefs.h>
__SCCSID("@(#)nls_cp10006.c	1.2 01/01/20 2000 J. Schilling");
__RCSID("$MirOS$");
/*
