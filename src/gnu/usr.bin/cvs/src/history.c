/* $MirOS: src/gnu/usr.bin/cvs/src/history.c,v 1.2 2005/03/13 15:50:38 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/cvs/src/history.c,v 1.2 2005/03/13 15:50:38 tg Exp $");
