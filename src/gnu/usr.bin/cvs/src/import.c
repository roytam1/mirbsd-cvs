/* $MirOS: src/gnu/usr.bin/cvs/src/import.c,v 1.3 2005/04/19 20:58:20 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/cvs/src/import.c,v 1.3 2005/04/19 20:58:20 tg Exp $");
