/* $MirOS: src/gnu/usr.bin/binutils/binutils/readelf.c,v 1.3 2005/03/28 22:06:03 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/binutils/binutils/readelf.c,v 1.3 2005/03/28 22:06:03 tg Exp $");
