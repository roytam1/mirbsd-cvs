/* $MirOS: src/gnu/usr.bin/binutils/binutils/objcopy.c,v 1.2 2005/03/13 16:06:53 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/binutils/binutils/objcopy.c,v 1.2 2005/03/13 16:06:53 tg Exp $");
