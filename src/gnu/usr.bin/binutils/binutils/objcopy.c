/* $MirOS: src/gnu/usr.bin/binutils/binutils/objcopy.c,v 1.4 2005/06/05 21:24:05 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/binutils/binutils/objcopy.c,v 1.4 2005/06/05 21:24:05 tg Exp $");
