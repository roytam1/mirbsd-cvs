/* $MirOS: src/gnu/usr.bin/binutils/opcodes/tic30-dis.c,v 1.3 2005/06/05 21:24:50 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/binutils/opcodes/tic30-dis.c,v 1.3 2005/06/05 21:24:50 tg Exp $");
