/* $MirOS: src/gnu/usr.bin/binutils/libiberty/cplus-dem.c,v 1.2 2005/03/13 16:07:09 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/binutils/libiberty/cplus-dem.c,v 1.2 2005/03/13 16:07:09 tg Exp $");
