/* $MirOS: src/gnu/usr.bin/binutils/bfd/elf.c,v 1.3 2005/03/28 21:51:02 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/binutils/bfd/elf.c,v 1.3 2005/03/28 21:51:02 tg Exp $");
