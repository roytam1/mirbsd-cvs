/* $MirOS: src/gnu/usr.bin/binutils/bfd/elf.c,v 1.4 2005/06/05 21:23:55 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/binutils/bfd/elf.c,v 1.4 2005/06/05 21:23:55 tg Exp $");
