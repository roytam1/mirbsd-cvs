/* $MirOS: src/gnu/usr.bin/binutils/bfd/elf.c,v 1.2 2005/03/13 16:06:46 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/binutils/bfd/elf.c,v 1.2 2005/03/13 16:06:46 tg Exp $");
