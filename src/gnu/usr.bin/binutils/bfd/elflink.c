/* $MirOS: src/gnu/usr.bin/binutils/bfd/elflink.c,v 1.2 2005/03/13 16:06:48 tg Exp $ */
...
__RCSID("$MirOS: src/gnu/usr.bin/binutils/bfd/elflink.c,v 1.2 2005/03/13 16:06:48 tg Exp $");
