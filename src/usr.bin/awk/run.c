...
Cell	*jret	= &retcell;
static char tempcell_i[] = "";
static Cell	tempcell	={ OCELL, CTEMP, 0, tempcell_i, 0.0, NUM|STR|DONTFREE, NULL };
...
{
	static char newcopycell_i[] = "";
	static Cell newcopycell = { OCELL, CCOPY, 0, newcopycell_i, 0.0, NUM|STR|DONTFREE, NULL };
	int i, ncall, ndef;
