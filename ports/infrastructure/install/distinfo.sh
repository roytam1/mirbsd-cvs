# $MirOS: ports/infrastructure/install/distinfo.sh,v 1.94 2009/10/24 18:42:17 tg Exp $
...
make)
	...
	f_path=mir/make
	distinfo_md5=caa41ad861722914ec0411c706995861
	distinfo_sum=2957498700
	distinfo_size=383230
	distinfo_date="Nov 22 20:44"
	;;
mksh)
	f_key=gzsigkey.pub
	f_ver=39
