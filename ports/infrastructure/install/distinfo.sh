# $MirOS: ports/infrastructure/install/distinfo.sh,v 1.91 2009/08/30 18:14:06 tg Exp $
...
make)
	...
	f_path=mir/make
	distinfo_md5=4aab31317d7f764e235036ef4db7f523
	distinfo_sum=1441690492
	distinfo_size=372470
	distinfo_date="Aug 30 22:08"
	;;
mksh)
	f_key=gzsigkey.pub
	f_ver=39
