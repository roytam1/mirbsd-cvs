# $MirOS: ports/infrastructure/install/distinfo.sh,v 1.1.2.2 2005/09/12 20:36:32 tg Exp $
...
make)
	...
	f_path=mir/make
	distinfo_md5=75b7505028908308328fcf90fa889c0a
	distinfo_sum=700998647
	distinfo_size=314201
	distinfo_date="Sep 12 21:56"
	;;
mksh)
