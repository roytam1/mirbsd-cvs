# $MirOS: ports/infrastructure/install/distinfo.sh,v 1.55 2007/07/26 22:22:44 tg Exp $
...
mksh)
	...
	f_path=mir/mksh
	distinfo_md5=039354a01f1e3877cd4e0dde74cfa2a3
	distinfo_sum=4239235536
	distinfo_size=247655
	distinfo_date="Sep  7 21:00"
	;;
mtree)
	f_key=signkey
	f_ver=20050912
