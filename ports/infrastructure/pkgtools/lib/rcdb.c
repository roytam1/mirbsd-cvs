/* $MirOS: ports/infrastructure/pkgtools/lib/rcdb.c,v 1.2 2005/05/21 00:16:05 tg Exp $ */
...
__RCSID("$MirOS: ports/infrastructure/pkgtools/lib/rcdb.c,v 1.2 2005/05/21 00:16:05 tg Exp $");
