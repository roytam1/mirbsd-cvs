...
# $MirOS: contrib/gnu/libtool/libtool.m4,v 1.24 2005/05/21 13:59:46 tg Exp $
# _MirOS: contrib/gnu/libtool/libtool.m4,v 1.24 2005/05/21 13:59:46 tg Exp $
...
_lt_compiler_boilerplate=$(<conftest.err)
$rm conftest*
])# _LT_COMPILER_BOILERPLATE
...
_lt_linker_boilerplate=$(<conftest.err)
$rm conftest*
])# _LT_LINKER_BOILERPLATE
...
case $host_os in
  ...
  osf4* | osf5*)
	...
	_LT_AC_TAGVAR(archive_expsym_cmds, $1)='for i in $(<$export_symbols); do printf "%s %s\\n" -exported_symbol "\$i" >> $lib.exp; done~
	  echo "-hidden">> $lib.exp~
